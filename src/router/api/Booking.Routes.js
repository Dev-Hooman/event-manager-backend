...
import { createBooking, getBookings, getUserBookings, cancelBooking, updateBookingStatus } from "../../controllers/Booking.Controller.js";
...
BookingRouter.patch("/update-booking-status/:bookingId", authenticate, CheckRole(["superadmin"]), updateBookingStatus);
